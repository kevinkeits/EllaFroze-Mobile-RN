  ...
  const handleNavigate = (itemId: string) => {
    ...
    const renderItem = ({item}:any) => {
        ...
        {loading ? (<View style={{backgroundColor:"#EAEAEA", width:120, height:155}}/>) : (
            <Image source={{ uri: `https://ellafroze.com/api/uploaded/product/${item.ImagePath}`}} style={{width:155, height:155}} placeholder={blurhash} transition={1000} contentFit="cover"/>
            // <FastImage
